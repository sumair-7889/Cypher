...
class TaskSchedulingService {
  ...
  DateTime _calculateNextExecutionTime(RecurringSchedule schedule) {
    ...
    if (schedule.type == 'daily') {
      var nextTime = DateTime(now.year, now.month, now.day, schedule.hour, schedule.minute);
  ...
  Map<String, dynamic> _jsonDecode(String jsonStr) {
    // Simple JSON decoding - in production would use json package
    throw UnimplementedError('Use json package for production');
  }
}
